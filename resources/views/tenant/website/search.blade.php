...
<main>
        ...
        <header class="hero-section mb-4 border-bottom">
            <div class="container text-center">
                <h1 class="display-4 fw-bold mb-3" id="page-title">
                    Busca de Imóveis
                </h1>
                <p class="lead" id="page-subtitle">
                    Encontre o imóvel dos seus sonhos de forma simples e segura.
                </p>
            </div>
        </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    <section id="busca" style="padding: 3rem 0;">
                        <form id="filter-form">
                            <div class="mb-3 mt-2">
                                <small class="text-muted d-block">Use os filtros para refinar sua busca.</small>
                            </div>
                            <div class="row g-3">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <label for="purpose-select" class="form-label">Finalidade:</label>
                                ...
                                <div class="col-12">
                                    <label for="location-code" class="form-label">Localização ou Código:</label>
                                    <input type="text" class="form-control" id="location-code" placeholder="Digite bairro, cidade ou código do imóvel">
                                </div>
                            </div>
                            <div class="mt-4" id="advanced-filters">
                                <div class="row g-3">
                                    <div class="col-12">
                                        <label for="price-range" class="form-label">Faixa de Preço</label>
                                        <select class="form-select" id="price-range"></select>
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label mb-2">Detalhes do Imóvel</label>
                                        <div class="row g-2">
                                            <div class="col-12">
                                                <div class="mb-2">
